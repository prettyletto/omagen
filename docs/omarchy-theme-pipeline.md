...
| `omagen.bar.toml` | Omagen `DockedBarSurface.qml` | Omagen-owned metadata; no native Omarchy reader was found |
...
into `shell.toml`; they are not independently loaded by Quickshell.
