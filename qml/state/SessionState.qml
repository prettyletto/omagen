...
QtObject {
    ...
    function clear() { active=false; sessionId=""; originalTheme=""; originalBackgroundKind=""; originalBackgroundPath=""; shellStyle=({ surface: "flat", detail: "native" }); barStyle=({ surface: "native", density: "native", attention: "semantic", form: "continuous" }); clearGeneration() }
}
