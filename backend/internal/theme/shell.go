...
func WriteShell(themeDir string, palette Palette, surface, detail, barSurface, barDensity, barAttention string) error {
	...
	fmt.Fprintf(&b, "# Generated by Omagen. Shell: surface=%s detail=%s. Bar: surface=%s density=%s attention=%s.\n", surface, detail, barSurface, barDensity, barAttention)
	...
	if err := appendBarOverrides(&b, palette, barSurface, barDensity, barAttention); err != nil {
		return err
	}
